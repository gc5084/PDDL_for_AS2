...
(:init (place node0-0) (place node0-1) (place node0-2) (place node0-3) (place node0-4)
	...
	(box box0) (at box0 node1-2) (locked box0) (box-color box0 red)
	(box box1) (at box1 node3-1) (locked box1) (box-color box1 green)
	(box box2) (at box2 node2-4) (locked box2) (box-color box2 blue)
	(key key0) (at key0 node1-4) (key-color key0 red)
	(key key1) (at key1 node4-2) (key-color key1 green)
	(key key2) (at key2 node3-4) (key-color key2 blue)
